...
// Validate checks the field values on NoteContent with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *NoteContent) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on NoteContent with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in NoteContentMultiError, or
// nil if none found.
func (m *NoteContent) ValidateAll() error {
	return m.validate(true)
}

func (m *NoteContent) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if err := m._validateEmail(m.GetEmail()); err != nil {
		err = NoteContentValidationError{
			field:  "Email",
	...
	if len(errors) > 0 {
		return NoteContentMultiError(errors)
	}

	return nil
}

func (m *NoteContent) _validateHostname(host string) error {
...
func (m *NoteContent) _validateEmail(addr string) error {
...
// NoteContentMultiError is an error wrapping multiple validation errors
// returned by NoteContent.ValidateAll() if the designated constraints aren't met.
type NoteContentMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m NoteContentMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m NoteContentMultiError) AllErrors() []error { return m }

// NoteContentValidationError is the validation error returned by
// NoteContent.Validate if the designated constraints aren't met.
type NoteContentValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e NoteContentValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e NoteContentValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e NoteContentValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e NoteContentValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e NoteContentValidationError) ErrorName() string { return "NoteContentValidationError" }

// Error satisfies the builtin error interface
func (e NoteContentValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = NoteContentValidationError{}
...
func (m *UpdateNoteInfo) _validateHostname(host string) error {
	s := strings.ToLower(strings.TrimSuffix(host, "."))
...
func (m *UpdateNoteInfo) _validateEmail(addr string) error {
	a, err := mail.ParseAddress(addr)
	if err != nil {
		return err
	}
...
func (m *UpdateNoteRequest) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetUpdateNoteInfo()).(type) {
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UpdateNoteRequestValidationError{
					field:  "UpdateNoteInfo",
					reason: "embedded message failed validation",
					cause:  err,
				})
			}
	...
	} else if v, ok := interface{}(m.GetUpdateNoteInfo()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
...
// Validate checks the field values on GetNoteListResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetNoteListResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetNoteListResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetNoteListResponseMultiError, or nil if none found.
func (m *GetNoteListResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetNoteListResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetNoteListResponseMultiError(errors)
	}

	return nil
}

// GetNoteListResponseMultiError is an error wrapping multiple validation
// errors returned by GetNoteListResponse.ValidateAll() if the designated
// constraints aren't met.
type GetNoteListResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetNoteListResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetNoteListResponseMultiError) AllErrors() []error { return m }

// GetNoteListResponseValidationError is the validation error returned by
// GetNoteListResponse.Validate if the designated constraints aren't met.
type GetNoteListResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetNoteListResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetNoteListResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetNoteListResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetNoteListResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetNoteListResponseValidationError) ErrorName() string {
	return "GetNoteListResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetNoteListResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetNoteListResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetNoteListResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetNoteListResponseValidationError{}
